...
#### Scenario: Dumps and drafts still count in the census
...
#### Scenario: Dumps-area concepts are not in the attention list
...
#### Scenario: A draft outside both inbox areas still needs attention
...
#### Scenario: Drilling into the dumps inbox
...
#### Scenario: Dumps are identifiable in JSON
...
#### Scenario: The drafts inbox is always visible
...
#### Scenario: An empty drafts inbox
